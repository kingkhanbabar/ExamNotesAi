  ...
  return (
    <div className='min-h-screen overflow-hidden bg-white text-black px-8'>
      ...
      <main className='max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center'>
        ...
        {/* Left content */}
        <motion.div
          initial={{ opacity: 0, x: -60 }}   // ✅ moved inside tag
          animate={{ opacity: 1, x: 0 }}     // ✅ fixed x instead of y
          transition={{ duration: 1.5 }}
        >
          ...
          bg-clip-text text-transparent'>
            ...
            create exam notes ,project notes, charts,graphs and downloads clean PDFs-instantly using AI

          </p>
          <p className='mt-4 text-sm text-gray-500'>Start with 50 free credits . Upgrade anytime for more cfredits .Instant access</p>
        </motion.div>

        {/* Right content */}
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
          <Feature icon="🎁" title="50 free credits " des="Start with 50 credits to generate notes without paying" />
          <Feature icon="📗" title="Exam Notes " des="revision ready exam oriented Notes " />
          <Feature icon="📁" title="Project Notes " des="Well structured documentation for assignment and project" />
...
function Feature({ icon, title, des }) {
  return (
    ...
    >
     ...
     bg-gradient-to-br from-white/10 to-transparent opacity-0 hover:opacity-100 transition-opacity pointer-events-none'/>
