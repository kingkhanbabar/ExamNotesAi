                ...
                {isSidebarOpen && 
                 ...
                 overflow-y-auto'>
                    ...
                    <div className='mb-4 space-y-1'>
                        <button onClick={()=>navigate("/notes")} className='w-full px-3 py-2 rounded-lg text-sm text-start text-gray-200 bg-white/10
                        hover:bg-white/20'>
                            ➕New Notes
                        </button>
                        <hr className='border-white/10 mb-4'/>

                        <h2 className='mb-4 text-lg font-bold bg-gradient-to-r from-white via-gray-300 to-white 
                        bg-clip-text text-transparent'>
                            📚 Your Notes
                        </h2>
                        {topics.length ===0 &&(
                           ...
                           {topics.map((t,i)=>(
                               ...
                               `}>
                                    ...
                                    <div className='flex flex-wrap gap-2 mt-2 text-xs'>
                                       ...
                                       text-purple-300'>Exam Type : {t.examType}</span>}
                                    </div>
