    ...
    return (
        ...
        className='text-center mb-10'>
           ...
           <div className='max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6'>
             ...
             amount={100}
             credits="50 Credits"
             descriptions=" perfect for quick revisions"
             features={[
                "Generative Ai notes",
                "Exam-focused notes",
            ...
            <PricingCard 
             ...
             amount={200}
             credits="120 Credits"
             descriptions="Best value for students"
             features={[
            ...
            <PricingCard 
             ...
             amount={500}
             credits="300 Credits"
             descriptions="For serious exam Prepration"
             features={[
                "Maximum Credits values",
                "Unlimited Revision",
                "Charts and diagrams",
                "Idle for full sylabus" 
             ]}
             selectedPrice={selectedPrice}
             setSelectedPrice={setSelectedPrice}
...
function PricingCard({
    ...
    return(
        ...
        ${
            ...
            <p className='text-sm text-gray-500 mt-1'>{descriptions}</p>
