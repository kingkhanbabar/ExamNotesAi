    ...
    <div className='min-h-screen overflow-hidden bg-white text-black'>
      ...
      <section className='max-w-7xl mx-auto px-8 pt-32 grid grid-cols-1 
        ...
        <div>
          ...
          >
            <motion.h1
              className="text-5xl lg:text-6xl font-extrabold leading-tight bg-gradient-to-r from-black/90 via-black/60 to-black/90 bg-clip-text text-transparent"
              whileHover={{ y: -4 }}
              style={{
            ...
            >
              Create Smart <br /> AI Notes in
              <br />Seconds
            </motion.h1>
            <motion.p
              whileHover={{ y: -2 }}
              className="mt-6 max-w-xl text-lg whitespace-pre-line bg-gradient-to-br from-gray-700 via-gray-500/80 to-gray-700 bg-clip-text text-transparent"
              style={{
                transform: "translateZ(40px)",
                textShadow: "0 18px 40px rgba(0,0,0,0.25)",
              }}
