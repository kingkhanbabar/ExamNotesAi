...
return ()=>clearInterval(interval);
  ...
  text-white"
        >
            <input type="text" className='w-full p-3 rounded-xl bg-white/10
            backdrop-blur-lg
            border border-white/20
            placeholder-gray-400
            text-white
            focus:outline-none focus:ring-white/30' placeholder='Enter Topic(eg Web Dev)'
        ...
        {loading &&
            ...
            className='h-full bg-gradient-to-r from-green-400 via-emerald-400 to-green-500'>
              ...
              <div className='flex justify-between text-xs text-gray-300'>
                ...
                This may take to 2-5 minutes Please don't close or refres the page.
...
function Toggle({ label, cheacked, onChange }) {
    return (
        <div className='flex items-center gap-4 cursor-pointer select-none' onClick={onChange}>
            ...
            <span className={`text-sm transition-colors ${cheacked ? "text-green-300" : "text-gray-300"}`}>{label}</span>
        </div>
