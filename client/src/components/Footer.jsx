        ...
        shadow-[0_25px_60px_rgba(0,0,0,0.7)]'>
            <div className='grid grid-cols-1 md:grid grid-cols-3 gap-8 items-start'>
                ...
                >
                    ...
                    <p className='text-sm text-gray-300 max-w-sm'>ExamNotes Ai helps
                        studenmts genarte exam-focused notes,revision
                        material,diagram, and printable PDFs using AI
                    </p>
                </motion.div>
                ...
                <div className='text-center'>
                    ...
                    <ul className='space-y-2 text-sm'>
                        ...
                        <li onClick={handleSignOut} className='text-red-300 hover:text-red-300 transition-colors'>SignOut</li>
                        <li className='text-gray-300 hover:text-white transition-colors'>support@exam.com</li>
                    </ul>
                </div>
            </div>
